...
public class MainActivity extends AppCompatActivity implements FrameProcessor {
    ...
    private RecyclerView bottomSheetRcyclerView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomSheetRcyclerView=findViewById(R.id.bottom_sheet_recycler_view);
        ...
        bottomSheetRcyclerView.setLayoutManager(new LinearLayoutManager(MainActivity.this));
        bottomSheetRcyclerView.setAdapter(new FaceDetectionAdapter(faceDetectionModels,MainActivity.this));
    ...
    private void analyseImage(final Bitmap bitmap) {
        ...
        bottomSheetRcyclerView.getAdapter().notifyDataSetChanged();
    ...
    private void detectFaces(List<FirebaseVisionFace> firebaseVisionFaces, Bitmap mutableImage) {
     ...
     {
         Toast.makeText(this,"tthere was an error",Toast.LENGTH_SHORT).show();
         return;
 ...
 /*
        ...
        FirebaseVisionImageMetadata metadata=
                ...
                .setRotation(
                        (cameraFacing==Facing.FRONT)?FirebaseVisionImageMetadata.ROTATION_270:FirebaseVisionImageMetadata.ROTATION_90
